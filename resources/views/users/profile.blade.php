                ...
                <div class="profile-header">
                    <div class="profile-card">
                        <div class="userCover-panel">
                            <div class="userCover">
                                <img class="userCover-img" src="{{url('/image/pattern.jpeg')}}" alt="">
                            ...
                            <div class="header-wrapper-main">
                                <div class="user-profile-avatar">
                                    <div class="userAvatar">
                                        <img src="{{url("/image/{$user->avatar}.png")}}" alt="">
                                    </div>
                                </div>
                                <div class="profile-header-content">
                                    ...
                                    <div class="profile-header-conBody">
                                        <div class="ProfileHeader-info">
                                            ...
                                            <div class="ProfileHeader-infoItem">
                                                <i class="fa fa-github"></i>{{$user->setting['qq']}}
                                            </div>
                                            <div class="ProfileHeader-infoItem">
                                                <i class="fa fa-github"></i>{{$user->setting['sex']}}
                                            </div>
                                            <div class="ProfileHeader-infoItem">
                                                <i class="fa fa-cloud"></i>{{$user->setting['brief']}}
                                            </div>
                                        </div>
                                    </div>
                                    @if(Auth::id()===$user->id)
                                        <a href="{{url('/setting')}}" class="ui button inverted blue edit-profile-user">个人设置</a>
                                    @else
